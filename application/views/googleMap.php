                  ...
                  <li>
                    <div id="Demo1" class="w3-hide">
                      <div class="row p-2">
                        ...
                        <div class="col-lg-4" align="center">
                          <a class="w3-button mapimage_style" onclick="changeStyle('<?= base_url(); ?>styles/outdoor-green-style.json')">
                        ...
                        <div class="col-lg-4" align="center">
                          <a class="w3-button mapimage_style" onclick="changeStyle('<?= base_url(); ?>styles/black-and-white-style.json')">
                            <img class="image_style" src="<?= base_url(); ?>images/black_white.png" height="30%" width="65%" style=" border: 2px solid black;" />
            ...
            <div class="test-shadow" id="test-shadow">
              ...
              <div id="map" class="d-flex align-items-center" align="center">
                <div id="mainFrame" class="mainFrame_1 mapboxgl-ctrl-bottom-left customName_bottom_blur pt-3" align="center">
                  <p id="frameText" class="font_style mb-0 frameText">Lahore</p>
                ...
                <div id="mainFrame" class="mainFrame_3 mapboxgl-ctrl-bottom-left customName_bottom_blur" align="center">
                  ...
                  <table class="table table-bordered " style="display:none;" id="mapTable" >
                    <tbody align="center">
                      <tr align="center">
                        <td class="gradientBackground">&nbsp;</td>
                        <td rowspan="2">DOSSARD <br> 80</td>
                        <td>9HOO^dep</td>
                        <td colspan="2">12.5 KM</td>
                      </tr>
                      <tr align="center">
                        <td>880M D+</td>
                        <td colspan="2">16&#176;C MIN/24&#176;C MAX</td>
                        <td class="gradientBackground">&nbsp;</td>
                      </tr>
                      <tr>
                        <td><?= date('d-m-Y'); ?></td>
                        <td colspan="2">250/256 Finishers</td>
                        <td>7.43 NoY`</td>
                        <td rowspan="2">Jerome SERQ'</td>
                      </tr>
                      <tr>
  ...
  try {
    ...
    $(document).ready(function(e) {
      ...
      function updateRoute(routeJSON, updateLayers = true) {
        ...
        color_line= '';
        if(styleSelect_.includes("black-and-white-style.json")){
          color_line='white';
        }else{
          color_line='darkgray';
        }
          ...
          if (!map.getLayer(layer.id) && map.getSource(layer.source)) {
            if (layer.source && (layer.source !== 'composite')) {
              if(layer.id == 'route-layer'){
                ...
                layer.paint={'line-color': color_line, 'line-width': 6};
              }
